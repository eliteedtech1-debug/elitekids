...
const ERROR_MAP: Record<string, string> = {
  ...
  ADE_FORBIDDEN: 'error.adeForbidden',
  ADE_INVALID_CORRECT: 'error.adeInvalidCorrect',
  ADE_SERVER_ERROR: 'error.adeServerError',
  ...
  SRE_FORBIDDEN: 'error.sreForbidden',
  SRE_SERVER_ERROR: 'error.sreServerError',
  ...
  ECO_ITEM_REQUIRED: 'error.ecoItemRequired',
  ECO_PURCHASE_FAILED: 'error.ecoPurchaseFailed',
  ECO_SERVER_ERROR: 'error.ecoServerError',
