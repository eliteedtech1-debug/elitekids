...
| Q29 | Q2-E Portfolio frontend (SkillMap + EvidenceGallery + export button on ParentDashboard/Teacher view) | opencode (after Q28 MERGED) | QUEUED (hold released — Q28 MERGED 2026-09-03) |
