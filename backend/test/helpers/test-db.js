...
CREATE TABLE IF NOT EXISTS kids_children (
  ...
  age_level ENUM('Crèche','Nursery','KG1','KG2','Primary','Playgroup','Nursery 1','Nursery 2','Kindergarten') NOT NULL DEFAULT 'Nursery',
  class_code VARCHAR(50) NULL,
...
CREATE TABLE IF NOT EXISTS kids_lessons (
  ...
  age_level ENUM('Crèche','Nursery','KG1','KG2','Primary','Playgroup','Nursery 1','Nursery 2','Kindergarten') NOT NULL,
  ...
  nerdc_code VARCHAR(100) NULL DEFAULT NULL,
  nerdc_strand VARCHAR(100) NULL DEFAULT NULL,
  nerdc_sub_strand VARCHAR(100) NULL DEFAULT NULL,
  createdAt DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
  updatedAt DATETIME NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS kids_learning_goals (
  ...
  set_by ENUM('child','teacher','auto') NOT NULL DEFAULT 'auto',  status ENUM('active','done','expired') NOT NULL DEFAULT 'active',
  createdAt DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
  updatedAt DATETIME NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
