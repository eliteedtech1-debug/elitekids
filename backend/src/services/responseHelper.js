...
const ERROR_CODES = {
  ...
  // NGEd-game Q1 — ADE v2 (SRS §10.2)
  ADE_INVALID_SKILL_KEY: 'ADE_INVALID_SKILL_KEY',
  ADE_INVALID_QUALITY: 'ADE_INVALID_QUALITY',
  ADE_INVALID_ITEM_ID: 'ADE_INVALID_ITEM_ID',
  ADE_SKILL_NOT_FOUND: 'ADE_SKILL_NOT_FOUND',

  // NGEd-game Q1 — SRE v2 (SRS §10.2)
  SRE_REVIEW_NOT_FOUND: 'SRE_REVIEW_NOT_FOUND',
  SRE_INVALID_QUALITY: 'SRE_INVALID_QUALITY',

  // NGEd-game Q1 — Economy + Shop (SRS §10.2)
  ECO_INSUFFICIENT_XP: 'ECO_INSUFFICIENT_XP',
  ECO_ITEM_NOT_FOUND: 'ECO_ITEM_NOT_FOUND',
  ECO_ITEM_ALREADY_OWNED: 'ECO_ITEM_ALREADY_OWNED',
  ECO_ITEM_NOT_OWNED: 'ECO_ITEM_NOT_OWNED',
  ECO_DAILY_LIMIT_REACHED: 'ECO_DAILY_LIMIT_REACHED',
  ECO_INVALID_ACTION: 'ECO_INVALID_ACTION',
};
